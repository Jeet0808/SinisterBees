        ...
        if (err.response) {
            ...
            switch (err.response.status) {
              case 400: // Bad Request
                ...
                alert('There was an issue with your request. Please check and try again.');
                break;
              ...
              case 500: // Internal Server err
                console.error('Internal Server err: Something went wrong on the server.');
              ...
              default:
                ...
                alert(`An unexpected err occurred (Status Code: ${err.response.status}).`);
            }
        return Promise.reject(err)
    }
